          ...
          <div className="px-md-0">
            <div className="row d-flex no-gutters">
              ...
              <div className=" col-lg-4 col-md-5 d-flex align-items-stretch">
                <div
                  className="info-wrap js-fullheight bg-yellow-dark w-100 p-md-5 p-4"
                  {...AOS_CONFIG.fade}
                >
                  <h3
                    className="text-uppercase heading text-secondary-emphasis"
                    {...AOS_CONFIG.zoom}
                  >
                    Let's get in touch
                  </h3>
            ...
            {/* Map */}
            <div className="row d-flex no-gutters" {...AOS_CONFIG.zoom}>
